...
public:
  ...
  auto callback() -> void {
    auto message = msg::HardwareStatus();

    message.version = this->version;
    message.temperature = this->temperature;
    message.online = this->online;
...
private:
  ...
  rclcpp::Publisher<msg::HardwareStatus>::SharedPtr pub;
};
